...
- [ ] Travel page rental car coordination: let guests enter their arrival date/time so they can find others to split a rental car with. Design agreed (double opt-in email, guests choose scope); see [pages/travel-coordination.md](pages/travel-coordination.md)
